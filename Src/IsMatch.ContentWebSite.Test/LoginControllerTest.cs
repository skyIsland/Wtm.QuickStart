...
using IsMatch.ContentWebSite.Controllers;
using IsMatch.ContentWebSite.ViewModel.HomeVMs;
using IsMatch.ContentWebSite.DataAccess;
using WalkingTec.Mvvm.Mvc;

namespace IsMatch.ContentWebSite.Test
{
    [TestClass]
